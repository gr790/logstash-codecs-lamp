...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :add_runtime_dependency then
    s.add_development_dependency(%q<gem_hadar>.freeze, ["~> 0.3.2"])
    s.add_development_dependency(%q<simplecov>.freeze, [">= 0"])
    s.add_runtime_dependency(%q<tins>.freeze, ["~> 0.8"])
  else
    s.add_dependency(%q<gem_hadar>.freeze, ["~> 0.3.2"])
    s.add_dependency(%q<simplecov>.freeze, [">= 0"])
    s.add_dependency(%q<tins>.freeze, ["~> 0.8"])
  end
end
